...
<div class="course_reviews">
    ...
    <div class="col-md-4">
      <div class="rating_snapshot">
        ...
        echo '<div class="modern-star-rating">';
            ...
            echo '</div>';
            echo '<span>'.$count.' '.__('estrellas','vibe').'</span>';
        ?>
      </div>
    </div>
    <div class="col-md-8">
      ...
      <?php
        foreach($ratings as $k => $rating){
          echo '<li><span>'.$k.' '.__('estrellas','vibe').'</span><strong><span style="width:'.(empty($count) ? 0 : (100*($rating/$count))).'%">'.$rating.'</span></strong></li>';
        }
      ?>
      </ul>
    </div>
  ...
  <div class="show_course_reviews">
      ...
      <a class="show_reviews" data-default="<?php _e('Mas valoraciones','vibe'); ?>" data-less="<?php _e('Menos opiniones','vibe'); ?>"><?php _e('Mas opiniones','vibe'); ?></a>
  <?php
    }
    ?>
    </div>
